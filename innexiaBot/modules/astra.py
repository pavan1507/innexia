...
moon_ani = [
            "CAACAgEAAx0CWmxDuwACGO9hDjwwZT5bb0HvnUbK0GOWpTcYegAC9AEAAi_HiUZ8_ezIyqhp9yAE",
            "CAACAgEAAx0CWmxDuwACGPBhDjw1whqqEQ7h8k77ufodftd4qAACpQEAAkhF-EaRgH4u5Lc-fSAE",    
            "CAACAgEAAx0CWmxDuwACGPFhDjw5JKikj2r2LiMJkdk4rFi4LQACbAEAAlUQ0UZz6ImBI4-4aiAE",
            "CAACAgEAAx0CWmxDuwACGPJhDjw6P33DsWxOUoFLWKXquxOzFwACJwIAAlPO0EYmQXMDpDooiiAE",
            "CAACAgEAAx0CWmxDuwACGPVhDjw8Ej60H9-mB1H7LXjc9MK4BwACUAEAAiKZ2Uaamc7MII9nGCAE",
            "CAACAgEAAx0CWmxDuwACGPRhDjw8ihKj81HANWXPb1lH9XH2BwACFgEAAuzi4UbIZ-jURSG0uCAE",
            "CAACAgEAAx0CWmxDuwACGPJhDjw6P33DsWxOUoFLWKXquxOzFwACJwIAAlPO0EYmQXMDpDooiiAE",
            "CAACAgEAAx0CWmxDuwACGRBhDj0n8l4AAZQ0vPU-5lguDYHDEJsAAmUBAAL60dhGBMTeJYQZ0JUgBA"
...
def moonanimation(update: Update, context: CallbackContext):
    bot, args = context.bot, context.args
    msg = update.effective_message.reply_sticker('CAACAgEAAx0CWmxDuwACGPVhDjw8Ej60H9-mB1H7LXjc9MK4BwACUAEAAiKZ2Uaamc7MII9nGCAE') 
    for x in range(EDIT_TIMES):
        msg.edit_text(moon_ani[x%32])
        time.sleep(EDIT_SLEEP)
    msg.edit_sticker('CAACAgEAAx0CWmxDuwACGRBhDj0n8l4AAZQ0vPU-5lguDYHDEJsAAmUBAAL60dhGBMTeJYQZ0JUgBA')
...
MOONANIMATION_HANDLER =DisableAbleCommandHandler("start",moonanimation)
