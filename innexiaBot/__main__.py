...
PM_START_TEXT = """
`Heya` 🤗 `I am` **Panuu** (https://telegra.ph/file/6b93ac5767c28ad29a130.jpg) `One of the best group managing bot`
...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="ᴏᴡɴᴇʀ", url=f"https://t.me/creatorpavanx"
        ),
    ],
    [
        InlineKeyboardButton(text=" Sᴜᴍᴍᴏɴ Mᴇ ", url="http://t.me/panuuXbot?startgroup=true"),
    ],
]
...
def innexia_about_callback(update, context):
    ...
    if query.data == "innexia_":
        query.message.edit_text(
            ...
            \n• @pannuXbot, bot creator and main developer.
...
def Source_about_callback(update, context):
    ...
    if query.data == "source_":
        query.message.edit_text(
            ...
            \n• Owner Of Bot [heyaaman](T.ME/creatorpavanx)
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 1232080004 and DONATION_LINK:
            update.effective_message.reply_text(
